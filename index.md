...
updated: 2026-06-07
last_ingest: 2026-06-11 (triage-agent session 11 — console UI (tabs/insights/detail/ask-Claude) + security fast-path + Phase-4 sandbox-resolution slice + standardized Jira ingest; demo pushed to next week → full-spec build sequence + Phase-4 research handoff; 184 tests, on main)
