...
- [[processes/distributed-workflow/active/aldc-launchpad/README|aldc-launchpad]] — Active workstream: Two-sided AI delivery platform (monorepo). Phase 0R DONE. Phase 0C (connector framework) + Phase 1A (credential dashboard) = DEMO PRIORITY. Phases 1B–1D queued. Master platform + per-client portal with Zeus Chat.
