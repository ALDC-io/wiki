...
| **Amazon Advertising API** | LWA OAuth | US/UK/CA profile IDs | Have — GEP production refresh token active (US); **UK exchange call scheduled Fri 2026-05-08 12:30 PM EST** | 1A |
