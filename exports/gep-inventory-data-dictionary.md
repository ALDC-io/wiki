...
| `CAPTURE_TIMESTAMP` | Exact timestamp of Amazon FBA snapshot | Only when row has FBA data. Used to identify FBA-sourced rows and detect moving-target source tables |
...
| `GEP2_AVAILABLE_COST` | `GEP2_AVAILABLE_QTY x GEP2_LAST_COST` | |
| `GEP2_ON_HAND_COST` | `GEP2_ON_HAND_QTY x GEP2_LAST_COST` | |
| `GEP2_AVAILABLE_RETAIL` | `GEP2_AVAILABLE_QTY x GEP2_LAST_SITE_PRICE` | |
| `GEP2_ON_HAND_RETAIL` | `GEP2_ON_HAND_QTY x GEP2_LAST_SITE_PRICE` | |
| `NON_SELLABLE_COST`, `NON_SELLABLE_RETAIL` | Non-sellable qty x unsellable unit cost / price | |
